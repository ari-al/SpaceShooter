...
using UnityEngine;
// TextMesh Pro 관련 컴포넌트에 접급하기 위해 선언
using TMPro;
...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
       ...
       // 두 가지 방법으로 하위에 있는 Transform 컴포넌트를 추출했는데, 모두 Parent의 Transform 컴포넌트도 같이 추출돼 변수에 저장됐다
    ...
    public void DisplayScore(int score){
        totScore += score;
        scroeText.text = $"<color=#00ff00>SCORE :</color> <color=#FF0000>{totScore:#,##0}</color>";
        // 스코어 저장
